import { Box, Button, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Divider, FormControl, InputLabel, MenuItem, Paper, Select, TextField, Typography } from '@mui/material';
...
const ClientInfo = ({
    ...
    return (
        <Dialog open={open} onClose={() => onClose(false)} disableAutoFocus maxWidth="xl">
            <form onSubmit={handleCreateClass} >
                <DialogTitle variant='h5' bgcolor="primary.main" color="#FFF" >Client's Info</DialogTitle>
                <Divider />
                <DialogContent >
                    ...
                    <Box component={"fieldset"} sx={{ borderColor: '#E7EBF1', borderWidth: '2px', borderRadius: 2, mt: 2 }}>
                        ...
                        <FormControl margin='dense'>
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                <DatePicker label="TPL" />
                            </LocalizationProvider>
                        </FormControl>

                            <p style={{marginTop:"25px"}}>to</p>

                        <FormControl margin='dense'>
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                <DatePicker label="Effectivity" />
                            </LocalizationProvider>
                        </FormControl>
                ...
                <DialogActions>
                    ...
                    <Button type='submit' disabled={disable} sx={{ mr: 1, mb: 1 }}>{disable && <CircularProgress size={16} color='inherit' />} <Typography component={'span'} ml={1}>{disable ? 'Loading...' : 'Submit'}</Typography></Button>
                </DialogActions>
            </form>

        ...
        prev?.map((lesson) => {
          if (lesson._id == response.data.result._id) {
            return {
              ...
              show: true,
              uri: `${baseURL}${response.data.result._id}`,
            };
          } else {
            return lesson;
          }
              ...
              >
                <Box p={2}>
                  <Typography variant="subtitle1" fontWeight={"700"}>
                    We accept the following files, under 100MB size:
                  </Typography>
                  <ul style={{ margin: 0 }}>
                    <li>
                      <Typography variant="subtitle2">
                        <strong>Documents:</strong> .doc, .docx, .pdf, .txt
                      </Typography>
                    </li>
                    <li>
                      <Typography variant="subtitle2">
                        <strong>Presentations:</strong> .ppt, .pptx, .pptm
                      </Typography>
                    </li>
                    <li>
                      <Typography variant="subtitle2">
                        <strong>Images:</strong> .jpg, .jpeg, .png
                      </Typography>
                    </li>
                    <li>
                      <Typography variant="subtitle2">
                        <strong>Videos:</strong> .mp4
                      </Typography>
                    </li>
                  </ul>
                </Box>
